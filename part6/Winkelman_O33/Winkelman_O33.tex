...
\author{Sherry Winkelman$^1$ and Arnold Rots$^1$}
\affil{$^1$Smithsonian Astrophysical Observatory}
...
\begin{figure}[top]
\plotone[height=1.75in]{./O33_f1.eps}
...
\begin{figure}[here]
\plotone[height=3.25in]{./O33_f2.eps}
...
\begin{figure}[here]
\plotone[height=1.5in]{./O33_f3.eps}
\caption[WordCloud]
 { \label{fig:WordCloud}
