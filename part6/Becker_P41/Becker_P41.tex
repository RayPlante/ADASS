...
Our ultimate goal was to identify, as much as possible, when downloads were scripted or automated, as opposed to hand-downloaded. Since mirrors of the Chandra archive (both official and unofficial / private) have popped up across the globe,\footnote{Italy, India and HEASARC currently host official archives; the UK used to have one.} we folded these into the analysis as well. Some mirrors are not explicitly identified as such, but are easy to spot since they periodically download the entire archive. Figure~\ref{fig:mirrorsAndBots} is a breakout of activity by year.
...
The Chandra archive has collected a great deal of data regarding downloads, and our modified and strengthened metadata skeleton is giving it much-needed form.
