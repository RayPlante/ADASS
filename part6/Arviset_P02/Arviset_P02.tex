...
\begin{abstract}
Most of ESA's \ssindex{archives!multiple!ESA's Space Science Archives (ESAC)}Space Science Archives are currently hosted at ESAC, the European Space Astronomy Centre, located near Madrid, Spain. All these science archives are designed, developed, operated and maintained by a dedicated Science Archives and\ssindex{Virtual Observatory(VO)} VO Team, providing support to all science operations centres at ESAC. At the end of 2011, a questionnaire was sent to all users of the ESAC Science Archives in the last five years, asking them about their usage frequency, their satisfaction level, the type of interfaces used (\ssindex{software!user interfaces}GUI or scriptable interface or others) and the purpose for which they are using the archives. The survey also allowed optionally to provide qualitative feedback. This paper presents the main results from this questionnaire, from a global perspective of all the archives.
\end{abstract}

\section{Science Archives at ESAC}
Over the years, ESAC has turned into a Science Data Centre, hosting most of ESA Space Science astronomy and solar system missions' archives (see Figure~\ref{P02_f1_Archives}) . This includes active archives for which new data are being ingested regularly, such as the \ssindex{archives!individual!XMM-Newton Science Archive (XSA)}\ssindex{observatories!space-based!XMM-Newton}XMM-Newton Science Archive (XSA), the \ssindex{archives!individual!Herschel Science Archive (HSA)}\ssindex{observatories!space-based!Herschel}Herschel Science Archive (HSA), the \ssindex{archives!individual!Integral SOC Science Data Archive (ISDA)}Integral SOC Science Data Archive (ISDA), the \ssindex{archives!individual!SOHO Science Archive (SSA)}\ssindex{observatories!space-based!SOHO}SOHO Science Archive (SSA), ESA's \ssindex{archives!multiple!Planetary Science Archive (PSA)}Planetary Science Archive (the PSA with Mars Express, Venus Express and Rosetta), the \ssindex{archives!individual!Planck Legacy Archive (PLA)}\ssindex{observatories!space-based!Planck}Planck Legacy Archive (PLA) and more recently in 2012, the European \ssindex{archives!individual!HST Archive}\ssindex{observatories!space-based!HST}HST Archive. Furthermore, support for legacy archives is also provided, such as for the \ssindex{archives!individual!ISO Data Archive (IDA)}ISO Data Archive (IDA), the \ssindex{archives!individual!EXOSAT Science Archive (EXSA)}\ssindex{observatories!space-based!Exosat}EXOSAT Science Archive (EXSA) and legacy planetary missions within the \ssindex{archives!multiple!Planetary Science Archive (PSA)}PSA (\ssindex{archives!individual!SMART-1}SMART-1, \ssindex{archives!individual!Huygens}\ssindex{observatories!space-based!Cassini-Huygens}Huygens and \ssindex{archives!individual!Giotto}Giotto). \ssindex{archives!individual!Cluster}Cluster and \ssindex{archives!individual!Ulysses}Ulysses final archives are being migrated to ESAC and development is starting for upcoming missions such as \ssindex{observatories!space-based!Gaia}Gaia, \ssindex{observatories!space-based!Euclid}Euclid, Solar Orbiter and BepiColombo.

The ESAC Science Archives provide complementary services to different types of users, primarily towards scientists to enable maximum scientific exploitation of data sets, but as well to science operations teams through cost-effective archive production by integration in, and across, projects. Furthermore, science archives must ensure efficient long-term \ssindex{data!preservation}preservation of data, software and knowledge for several decades, well after the mission lifetime itself, with sufficient flexibility to adapt to modern technology.

The Standard access to the archives is through powerful web based \ssindex{software!user interfaces}GUI interfaces (http://archives.esac.esa.int/), offering simple to use, powerful search and results facilities, handling of proprietary and public data, direct download, shopping basket, on the fly reprocessing (for some archives), links (back and forth) to the science literature and interoperability with external\ssindex{Virtual Observatory(VO)} VO Tools. Additionally, there are scriptable Archive Machine Interfaces which can be easily coupled with GRID to batch data \ssindex{data!access}access for further processing. These are mainly used by Science Operations Teams at ESAC and by the instrument teams for calibration and trend analysis purposes. These can also be used for systematic data processing by some projects (e.g. Herschel) or external mirror sites.
...
\item the type of archive interface mainly used (web \ssindex{software!user interfaces}GUI, scriptable interface, map based, or other, depending on the archive), 
...
The web interface remains the preferred option for users to access the archives (80\%), whereas the machine scriptable interface requires more expertise and is used by 9\% of them. Other interfaces dedicated for some archives are also used by 8\% for \ssindex{packages!HIPE}HIPE from the \ssindex{archives!individual!Herschel Science Archive (HSA)}\ssindex{observatories!space-based!Herschel}Herschel Science Archive, and 2\% for the Dataset Browser and 1\% for the Mars Map Browser, both from the \ssindex{archives!multiple!Planetary Science Archive (PSA)}Planetary Science Archive.

Overall, the results on the satisfaction with the Archives is very positive, with 22\% of users very satisfied, 41\% are satisfied, 30\% are neutral, 5\% are dissatisfied and 2\% very dissatisfied. The high percentage of neutral response might be due to the way the questions were asked, in the sense that satisfaction level was required to be given for all individual archives, although users usually do not use them all. The ratio of (very satisfied + satisfied)/(dissatisfied + very dissatisfied) = 9. In some cases the ratio for individual Archives is considerably higher, such as the \ssindex{archives!individual!XMM-Newton Science Archive (XSA)}\ssindex{observatories!space-based!XMM-Newton}XMM-Newton Science Archive (ratio of $\sim$23) and the \ssindex{archives!individual!SOHO Science Archive (SSA)}\ssindex{observatories!space-based!SOHO}Soho Science Archive (ratio of $\sim$18). 

It is also worth noting the intensive use of a legacy archive, such as the \ssindex{archives!individual!ISO Data Archive (IDA)}ISO Data Archive. As can be seen in the report, the \ssindex{archives!individual!ISO Data Archive (IDA)}ISO Data Archive is being used extensively, and we find a correlation of its usage with the usage of the \ssindex{archives!individual!Herschel Science Archive (HSA)}\ssindex{observatories!space-based!Herschel}Herschel Science Archive, which makes sense, as legacy archives of a determined wavelength range can be used for preparation of new observations in operational missions in the same wavelength range. This enhances the necessity and convenience of the Long Term \ssindex{data!preservation}preservation of ESA missions' archival data, and supports the approach taken at ESAC where the infrastructure for Science Archives allows for a low cost maintenance and operation of legacy archives.
...
The majority of feedback received was on the topic of the Archives Interfaces where the most common subjects discussed were the following: ease of use and layout of the \ssindex{software!user interfaces}graphical user interface, simple and advanced search options, query results and download options, common look and feel to the Archives, web interface versus \ssindex{computer languages!Java}Java (rich client) interface, and the archive scriptable machine interface.
