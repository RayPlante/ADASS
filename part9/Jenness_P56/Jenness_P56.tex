...
library that is available in Fortran as part of the Starlink\ooindex{Starlink, ascl:1110.012} Software
...
the GPL Fortran library included with the Starlink\ooindex{Starlink, ascl:1110.012} distribution.
...
The PAL library is now used within the Starlink\ooindex{Starlink, ascl:1110.012} AST library
