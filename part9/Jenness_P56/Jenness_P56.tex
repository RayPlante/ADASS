...
The PAL library is now used within the Starlink\ooindex{Starlink, ascl:1110.012} AST library \citep{2012ASPC..461..825B} and in all Starlink C applications that previously used SLALIB. It was shipped with the Starlink \textit{kapuahi} release \citep{P005_adassxxii}.
