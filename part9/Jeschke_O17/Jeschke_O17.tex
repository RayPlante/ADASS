...
viewer and toolkit based on Python astronomical packages such as pyfits\ooindex{PyFITS, ascl:1207.009}, numpy, scipy, matplotlib, and pywcs.  For developers, we present a set of python classes for viewing FITS files under the modern Gtk and Qt widget sets and a more  full-featured viewer that has a plugin architecture. We further describe how plugins can be written to extend the viewer with many different capabilities.  
