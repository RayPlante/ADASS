...
viewer and toolkit based on Python astronomical packages such as pyfits\ooindex{PyFITS, ascl:1207.009},
...
{\tt numpy}, {\tt pyfits}\ooindex{PyFITS, ascl:1207.009} \citep{Barrett99}, {\tt scipy} and 
...
{\tt pyfits}\ooindex{PyFITS, ascl:1207.009} objects, buffers or loaded from a file.  
There are several 
...
skycat\ooindex{SkyCat, ascl:1109.019} \citep{skycat} or DS9 (although not yet as feature complete).
