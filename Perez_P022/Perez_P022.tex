...
%Added by GMV to check PDF results
%\usepackage{epstopdf}
...
\markboth{Oscar Perez, Juan C. Vallejo, and Ruben F. Perez}{Oscar Perez, Juan C. Vallejo, and Ruben F. Perez}
...
\affil{$^1$GMV Aerospace and Defence, Isaac Newton 11, Tres Cantos, Madrid, Spain}
}
