\resetcounters
\markboth{Lee and Budav\'ari}{Cross-Identification of Astronomical Catalogs on Multiple GPUs}
...
\articlefigure[scale=0.4]{part8/Lee_P40/P040_f3.eps}{Lresults}{Speedup and Scaleup across GPU count and segment size} 
