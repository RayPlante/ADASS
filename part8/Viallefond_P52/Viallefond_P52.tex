...
Figure~2 reveals only one aspect of the concept 
...
Folding the three outer triangles of Figure~3 to join in the inner part 
leads to
\begin{figure}[h!]
\centering
...
Figure~4 highlights also the duality between two concepts,
the pair abstraction-completude. Completude induces closure, the meaning of this circle
in the diagrams.

\section{Conclusion}
The theory of the Measuremet Set (work in progress) reveals the ubiquity of a structure, 
...
to express the meaning of things, a conceptualization. Semantics is introduced by developing
structures which have symmetries, these introducing relations are carriers of meaning.
