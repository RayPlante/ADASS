...
\begin{abstract}
Multichannel image reconstruction, image analysis, and display ({\it Miriad}\ooindex{MIRIAD, ascl:1106.007}) 
...
{\it Miriad}\ooindex{MIRIAD, ascl:1106.007} CVS system (./miriad$_{-}$cvs/src/prog/sma) 
...
procedure. {\it Middle column} lists the {\it Miriad}\ooindex{MIRIAD, ascl:1106.007} tasks used in
...
for the submillimeter observations in {\it Miriad}\ooindex{MIRIAD, ascl:1106.007}.\footnote{Mark Gurwell, 
...
of processing SMA data in {\it Miriad}\ooindex{MIRIAD, ascl:1106.007} from reading data, calibrations
to final images.

\subsection{Tutorial Scripts }
One of the nice features in {\it Miriad}\ooindex{MIRIAD, ascl:1106.007} is that the detailed 
...
{\it Miriad}\ooindex{MIRIAD, ascl:1106.007} can be adapted for the SMA upgrade.  
...
with {\it Miriad}\ooindex{MIRIAD, ascl:1106.007}. 
