...
\begin{description}
\item[Shadowing] The MIRIAD\ooindex{MIRIAD, ascl:1106.007} task \verb#csflag# flag data based on antenna shadowing.
...
\end{figure}
\begin{figure}[!ht]
\plotfiddle{part7/Friedel_P12/point.eps}{-2in}{0}{30}{30}{30}{68}
\end{figure}
