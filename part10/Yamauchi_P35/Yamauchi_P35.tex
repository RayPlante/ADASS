...
\begin{tabular}{ll}
\hline
 \ssindex{catalogs!individual!2MASS}2MASS PSC (470,992,970 rows)    &        GSC-2.3.2 (945,592,683 rows) \\
\ssindex{catalogs!individual!WISE} \ssindex{observatories!space-based!WISE}WISE All-Sky (563,921,584 rows) &       UCAC3 (100,766,420 rows) \\
 USNO-B1.0 (1,045,175,762 rows) &       PPMXL (910,468,710 rows) \\
 AKARI IRC PSC (870,973 rows)    &       \ssindex{catalogs!individual!Tycho-2 stellar catalog}Tycho-2 (2,539,913 rows) \\
