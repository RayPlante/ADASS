...
fitting photometry, the $10$ individual exposures are co-added using {\tt SWarp}\ooindex{SWarp, ascl:1010.068}
(see Fig.\ \ref{Kufig1}). On the co-added image,
objects are detected with {\tt SExtractor}\ooindex{SExtractor, ascl:1010.064}  and the PSF is determined
...
input Sersic model as a function of the signal-to-noise ratio (SNR, from {\tt SExtractor}\ooindex{SExtractor, ascl:1010.064}).
