...
\markboth{Sergio~Pascual, M.~Carmen~Eliche-Moral, 
V\'ictor~Villar et al.}{Software toolkit for MEGARA}
...
\articlefigure{P21_ETC_Screenshot.eps}{ref:figetc}{GUI of the MEGARA ETC (version 0.0.5)}
...
\articlefiguretwo{P21_Simulator_scheme.eps}{P21_Simulated_sky.eps}{ref:figsim}{(Left) Steps of image simulation. (Right) Simulated sky exposure.}
