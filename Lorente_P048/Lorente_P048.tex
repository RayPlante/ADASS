...
%
  ...
  out. Additionally, through the Aladin display package, it provides
...
% \begin{enumerate}
% \item The target position is within the field-of-view of the fibre
%   hexabundle and that both of these coincide with the DSS galaxy.
% \item The field-of-view of the sky fibres is empty, as expected.
% \item The distribution of sky fibres is uniform across the plate.  
% \item There are no bright stars or extended galaxies sufficiently
%   close to a target position so as to pose a contamination risk.
% \end{enumerate}
