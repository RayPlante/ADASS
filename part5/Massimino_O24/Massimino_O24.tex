...
A standard \ssindex{astronomy!dark matter}dark matter \ssindex{simulations!N-body}N-body cosmological \ssindex{astronomy!simulation}simulation has been carried out in a computational box of 80 Mpc containing 500 million particles where each point represents a unit  of "\ssindex{astronomy!darm matter}dark matter", about 9.76 billion solar masses\footnote{The full movie at http://www.oact.inaf.it/visivo}. The global distribution of these units is the distribution of "\ssindex{astronomy!darm matter}dark matter" in the universe. Galaxies are not distributed randomly but tend to clump together, forming \ssindex{astronomy!cluster!galaxy}clusters of galaxies.
