...
Our sequential implementation outperforms the original \ssindex{software!tools!DUCHAMP}DUCHAMP algorithm for all datasets (Fig\ref{fig:H2}a).  It achieves this through removal of an unnecessary  trimming operation (GoodVoxelChecks) for handling padding in non-rectangular observations.  
