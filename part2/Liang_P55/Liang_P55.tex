...
% Note I had to force the bibliography by running bib text, and copying the relevant material from the BBL file so that I could hand chop it to fit in four pages.
...
\bibitem[{Antoniak(1974)}]{antoniak74}
...
\bibitem[{{Fadely} {\textit{et~al.}}(2012){Fadely}, {Hogg}, \& {Willman}}]{fadely12}
...
{Scranton}, R., \textit{et al.} 2002, \apj,
  579, 48.
