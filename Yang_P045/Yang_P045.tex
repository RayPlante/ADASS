...
\markboth{Lin Yang \& Alex Szalay}{A GPU-Based Visualization Method for Computing Dark Matter Annihilation Signal}

\begin{document}

\title{A GPU-Based Visualization Method for Computing Dark Matter Annihilation Signal}
\author{Lin~Yang$^1$ \& Alex~Szalay$^1$
\affil{$^1$ Department of Physics \& Astronomy, Johns Hopkins University}}
...
\begin{figure}[htb]
\begin{center}
 \includegraphics[width=120mm]{P045_f1}
...
\begin{figure}[htb]
\begin{center}
 \includegraphics[width=140mm]{P045_f3}
...
\begin{figure}[htb]
\begin{center}
 \includegraphics[width=110mm]{P045_f4}
...
\bibliography{P045}		% expects file "myrefs.bib"
\end{document}
