...
\markboth{Ott, S.}{Herschel Data Processing Development}
...
The Herschel Science Centre, the HIFI, PACS and SPIRE Instrument Control Centres (ICCs) and NHSC jointly manage and contribute to the Herschel Data Processing System (Ott, 2010). Delivery based contracts were awarded to the Instrument Control Centres to provide software to generate scientific useful data products and data visualisation and reduction tools.
...
% cost of data processing is nothing compared to the cost of the whole mission.
% But good quality of product %and tools will make the difference between
% a mission loved or despised by the astronomical community.
% Money saving: Understanding data early will ensure you don't observe
% with an inadequate mode (1 Mio Euro /day)
...
\item {\bf Evolution:} How to handle deprecations, replacements and standardisation for a system that evolves over a decade as much needed improvements will break existing functionality?
...
\reference Bauer, O.H., Estaria, P., King, K.J.\ et al. 1998, Proc.\ of SPIE, 3349, 312

\reference  Riedinger, J.R. 2009, ESA Bulletin 139, 14

\reference Pilbratt, G.L., Riedinger, J.R., Passvogel, T. et al.\
2010, A\&A, 518, L1

\reference Ott, S.\ 2010, ASP Conference Series, 434, 139
\end{references}
